...
import alteracaoPendenteRoutes from './modules/personagens/presentation/alteracao-pendente.routes'
import armasRoutes from './modules/armas/presentation/armas.routes'
...
app.use("/api", alteracaoPendenteRoutes)
